...
public class CustomerActionController {
	...
	public ModelAndView customerLogin(@Valid @Param("mobileNo")String mobileNo) {
		Customer cust = new Customer();
	...
	public ModelAndView withdrawWallet(@RequestParam("wallet.balance")BigDecimal amount) {
		System.out.println(wService.getCustomer());
		wService.withdrawAmount(wService.getCustomer().getMobileNo(), amount);
		return new ModelAndView("showBalance","customer",wService.getCustomer());
	}
	...
	public ModelAndView fundTransferWallet(@RequestParam("wallet.balance")BigDecimal amount, @RequestParam("mobileNo")String mobileNo){
		Customer cust = new Customer();
		cust=wService.showBalance(mobileNo);
