...
public class WalletServiceImpl implements WalletService{
	...
	public Customer showBalance(String mobileNo) throws CustomerDetailsNotFound{	
		...
		else throw new CustomerDetailsNotFound("Customer Details not found");
	...
	public Customer fundTransfer(String sourceMobileNo, String targetMobileNo, BigDecimal amount) throws InsufficientBalanceException{	
		...
		else throw new InsufficientBalanceException("Insufficient balance, cannot transfer");
		return customer;
	}
	...
	public Customer withdrawAmount(String mobileNo, BigDecimal amount) throws InsufficientBalanceException{ 
		...
		else throw new InsufficientBalanceException("Insufficient balance, Cannot withdraw");
